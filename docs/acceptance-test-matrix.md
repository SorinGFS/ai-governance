...
| WL-24 | The user asks why an action or disposition occurred. | Apply `Reason From Evidence` and explain it in plain language from the available applicable instructions, task decisions, Evidence Items, and Procedure Execution Records; identify historical information as historical and report any unavailable basis. | Explanation maps the action or disposition to its available recorded basis, labels historical information, and identifies missing support. |
