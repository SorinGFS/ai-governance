...
| The supplied Governance Configuration approves Git CLI independently from Git Bash; that executor approval leaves complete Operation Footprint, Permanent Constraint, and Dedicated Manager Operation classification in force for every Git invocation and `.git` effect. | `Establish Governance Configuration`, `Evaluate Operation Eligibility` |
